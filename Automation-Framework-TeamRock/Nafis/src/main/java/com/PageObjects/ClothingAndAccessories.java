...
//Checking if the hidden button was clicked and if they were clicking more items is possible or not
    ...
    public void hiddenButtonCategory1() throws InterruptedException {
        ...
        driver.navigate().back();
        driver.manage().timeouts().pageLoadTimeout(5,TimeUnit.SECONDS);        moveMouseTo(specialtyLink);
        specialtyLink.click();
        select_all_speciality.click();
        System.out.println("After Clicking the new Title is: "+driver.getTitle());
        goBack();
        driver.manage().timeouts().pageLoadTimeout(5,TimeUnit.SECONDS);        ebayLogo.click();
...
//Checking if the hidden button was clicked and if they were clicking more items is possible or not
    ...
    public void selectingOtherCategories() {
        clothesPage.click();
        waitFor(3);
        driver.manage().timeouts().pageLoadTimeout(5,TimeUnit.SECONDS);        luxaryWatchesLink.click();
        ...
        driver.manage().timeouts().pageLoadTimeout(5,TimeUnit.SECONDS);        personalizedItemsLink.click();
        System.out.println("Title is: "+driver.getTitle());
        System.out.println("Current URL is : "+ driver.getCurrentUrl());
        ...
        waitFor(3);
        driver.manage().timeouts().pageLoadTimeout(5,TimeUnit.SECONDS);        traditionalAndWorldClothingLink.click();
        System.out.println("Title is: "+driver.getTitle());
        System.out.println("Current URL is : "+ driver.getCurrentUrl());
